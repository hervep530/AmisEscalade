...
<c:if test="${fn:length(delivry.attributes.sites) gt 0}">
	<c:forEach items="${delivry.attributes.sites}" var="site">
				        <div class="media text-muted border-bottom border-gray pt-3 row">
				        	...
				        	<div class="media-body pb-3 mb-0 small lh-125 col-md-10">
				        		<div class="row">
					            	<span class="d-block text-gray-dark col-md-9">
