<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
				    <div id="main" class="container mb-2">
				      <div class="px-3 py-2">
				        <h1 class="mb-0 text-xxxl text-classic">Listes des topos...</h1>
				      </div>
				        	...
				        	<div class="media-body pt-2 mb-0 small lh-125 col-md-8">
				        		<h3 class="row text-normal">
						            <span class="d-block text-gray-dark col-md-8">
						            	<a class="pr-3" href="${pageContext.request.contextPath}/topo/r/${topo.id}/${topo.slug}">
						            		<strong><c:out value="${topo.name}"></c:out></strong>
						            	</a><c:out value="ecrit par ${topo.writer}"></c:out></span>
					            	<span class="col-sm-4">
					            		publié le ${topo.writedAt}
					            	</span>
				        		</h3>
