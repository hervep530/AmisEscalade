 ...
 *
 */
public abstract class DaoHibImpl implements Dao{
	...
	protected static void init() {
		if (em == null) {
			...
			em = Persistence.createEntityManagerFactory("pujpatest").createEntityManager();
		}
	}
	 ...
	 */
	protected static Object create(Class<?> entityClass, Object object) {
		init();
		try {
	 ...
	 * @return a user
	 */
	protected static Object get(Class<?> entityClass, Long id) {
		init();
	 ...
	 * @return a user
	 */
	protected static Object getFromClause(Class<?> entityClass, String[] attributes , Map<String,String> clauses) {
		init();
		Long id = null;
		Object obj = em.find(entityClass, id);
		return obj;
	 ...
	 * @param entityClass
	 * @param id
	 * @return if User is deleted or not
	 */
	protected static boolean delete(Class<?> entityClass, Long id) {
		init();
