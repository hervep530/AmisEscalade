...
/**
 * The persistent class for the jcm_image database table.
 * 
 */
@Entity
@Table(name="jcm_image")
@NamedQuery(name="JcmImage.findAll", query="SELECT j FROM JcmImage j")
public class JcmImage implements Serializable {
