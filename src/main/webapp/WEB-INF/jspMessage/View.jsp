<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<c:set var="focusedDiscussionId" value="${delivry.attributes.messageBox.focusedDiscussionId}" scope="page"></c:set>
<c:set var="focusedDiscussion" value="${delivry.attributes.messageBox.focusedDiscussion}" scope="page"></c:set>
<c:forEach items="${delivry.attributes.messageBox.discussions}" var="discussion">
						<div class="card mb-1">
							<div class="row no-gutters">
								<div class="col-md-4 row">
									<div class="col-md-2 pt-1">
									<img src="${pageContext.request.contextPath}/images/comment-writer.png" 
...
value="${discussion.sender.id == userId ? discussion.receiver.username : discussion.sender.username}">
									...
									<p class="card-title col-md-8 pt-2"><em>${interlocutor}</em></p>
								</div>
								<div class="col-md-8 row">
									<h6 class="card-text col-md-9 pt-2"><small class="text-muted">${discussion.title}</small></h6>
									<div class="col-md-3">
