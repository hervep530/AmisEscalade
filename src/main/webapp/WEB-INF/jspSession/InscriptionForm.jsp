<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<c:set var="form" value="${delivry.attributes.inscriptionForm}" scope="page"></c:set>
...
<!-- Username -->
				    	<div class="form-group mb-3">
				    		<label class="basic-top-label" for="username">
				    			<em>Nom d'utilisateur </em><span class="required">*</span><em> </em>
				    			<img alt="Icone aide" src="${helpIcon}" width="20" height="20" title="${form.nameHelp}"/>
				    		</label>
