...
<p class="text-center text-soft mt-5"><em>Aucun élément à afficher dans la vue.</em></p>
</c:if>
				        	...
				        	<div class="col-md-7 media-body pt-2 mb-0 small lh-125">
				        		<h3 class="row text-normal">
						            <span class="d-block text-gray-dark col-md-8">
						            	<a class="pr-3 link-help" href="${pageContext.request.contextPath}/site/r/${site.id}/${site.slug}">
