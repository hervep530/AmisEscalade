<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<c:set var="footerAuthor"
	value="${(service == 'topo' || service == 'site') && action == 'r' ? true : false}"
	scope="page" />
<c:set var="footerPagination"
	value="${(service == 'topo' || service == 'site') && action == 'l' ? true : false}"
	scope="page" />
...
<footer>
	<c:if test="${footerAuthor == true}">
		<p class="card-text col-md-3 ml-4 mb-4">
			<small class="text-muted"> Mis à jour par ${ site.author.username },
				il y a ${site.modifiedElapsedTime} </small>
		</p>
	</c:if>
